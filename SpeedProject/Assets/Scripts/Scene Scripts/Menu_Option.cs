...
public class Menu_Option : MonoBehaviour
{
    ...
    public async void Play()
    {
        ...
        CanvasGroup mode3 = GameObject.Find("3x4").GetComponent<CanvasGroup>();
        StartCoroutine(PhysicalFunctionHelper.Fade(mode3, 0, 1, 0.5f));
        await Task.Delay(150);

        CanvasGroup mode4 = GameObject.Find("4x4").GetComponent<CanvasGroup>();
        StartCoroutine(PhysicalFunctionHelper.Fade(mode4, 0, 1, 0.5f));
        await Task.Delay(150);

        CanvasGroup mode5 = GameObject.Find("4x5").GetComponent<CanvasGroup>();
        StartCoroutine(PhysicalFunctionHelper.Fade(mode5, 0, 1, 0.5f));
        await Task.Delay(150);

        CanvasGroup mode6 = GameObject.Find("4x6").GetComponent<CanvasGroup>();
        StartCoroutine(PhysicalFunctionHelper.Fade(mode6, 0, 1, 0.5f));
        await Task.Delay(150);

        CanvasGroup mode7 = GameObject.Find("5x6").GetComponent<CanvasGroup>();
        StartCoroutine(PhysicalFunctionHelper.Fade(mode7, 0, 1, 0.5f));
        await Task.Delay(150);

        CanvasGroup mode8 = GameObject.Find("6x6").GetComponent<CanvasGroup>();
        StartCoroutine(PhysicalFunctionHelper.Fade(mode8, 0, 1, 0.5f));
        await Task.Delay(150);

        CanvasGroup mode9 = GameObject.Find("6x8").GetComponent<CanvasGroup>();
        StartCoroutine(PhysicalFunctionHelper.Fade(mode9, 0, 1, 0.5f));
        await Task.Delay(150);

        CanvasGroup mode10 = GameObject.Find("6x10").GetComponent<CanvasGroup>();
